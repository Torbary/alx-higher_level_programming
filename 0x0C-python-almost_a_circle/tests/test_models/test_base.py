...
class TestBaseInstantiation(unittest.TestCase):
    ...
    def test_memoryview_id(self):
        self.assertEqual(memoryview(b'abcdefg'),
                         Base(memoryview(b'abcdefg')).id)
...
class TestBase_to_json_string(unittest.TestCase):
    """
    Unitest for testing to_json_string method of Base class
    """
...
class TestBase_from_json_string(unittest.TestCase):
    """Unitest for testing from_json_string method of Base class"""
...
class TestBase_create(unittest.TestCase):
    """unittest for testing the create method of Base class"""
